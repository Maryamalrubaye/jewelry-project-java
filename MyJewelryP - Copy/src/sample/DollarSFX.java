...
public class DollarSFX extends Application implements EventHandler<ActionEvent> {
    Stage sD;
    ...
    public void start(Stage stage) throws Exception {
        ...
        root.getChildren().addAll(pane1, label1, label2, label3, textField1, textField2, btn1, btn2, btn3, labelResult, textField3, btn4, btn5);
    ...
    public void handle(ActionEvent actionEvent) {
        jewelry = new CalculationForSilver();
        ...
        double result = jewelry.dollar(1, ONS, grams, wages);
