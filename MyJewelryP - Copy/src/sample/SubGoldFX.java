...
public class SubGoldFX extends Application {
   ...
   ChoiceBox choiceBox =new ChoiceBox();
    ...
    public void start(Stage stage) {
        ...
        Text text = new Text("Subtraction For Gold");
        text.setStyle(
        ...
        button.setMaxWidth(resultColumn.getPrefWidth());
        ...
        choiceBox.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
               ...
               g.subtraction(choice,resultSum);
            }
        });
